...
layout:setSize(cc.size(1604.0000, 446.0000))
layout:setLeftMargin(-802.0000)
...
itembg:setPosition(802.0000, 223.0000)
if callBackProvider~=nil then
      itembg:addTouchEventListener(callBackProvider("minigamelistcell_ipad.lua", itembg, "OnItemButton"))
end
