...
layout:setSize(cc.size(1180.0000, 516.0000))
...
itembg:setPosition(590.0000, 258.0000)
if callBackProvider~=nil then
      itembg:addTouchEventListener(callBackProvider("minigamelistcell_s8.lua", itembg, "OnItemButton"))
end
